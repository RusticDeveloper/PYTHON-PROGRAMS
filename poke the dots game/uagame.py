...
class Window:
    ...
    def draw_string(self, string, x, y,color='white'):
        ...
        text_image = self.__font__.render(string, True, Color(color), Color(self.__bg_color__))
        self.__surface__.blit(text_image, (x, y))
        rect_object = text_image.get_rect()
